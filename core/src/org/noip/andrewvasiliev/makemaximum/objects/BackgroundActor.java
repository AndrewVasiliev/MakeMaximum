    ...
    public BackgroundActor () {
        ...
        for (int j = 0; j< MAXLAYERS; j++) {
            for (int i = 0; i < MAXSTARSINLAYER; i++) {
                stars[j*MAXSTARSINLAYER + i] = new BackgroundStar(starTexture, j+1, MakeMaximum.WIDTH /*Constants.WIDTH*/);

                stars[j*MAXSTARSINLAYER + i].setPosition(random.nextInt(MakeMaximum.WIDTH /*Constants.WIDTH*/), random.nextInt(MakeMaximum.HEIGHT /*Constants.HEIGHT*/));
